...
public class Scene01 extends Scene {
    public Scene01(EntityBuilder entityBuilder) throws Exception {
        super(entityBuilder);
        this.addEntity("cube").color(1, 0, 0).scale(0.5f).move(0.5f, 0.5f, -2.25f);
        this.addEntity("cube").color(0, 0, 1).scale(0.5f).move(0.25f, 0.25f, 2.0f);
        this.addEntity("cube").color(1, 1, 1).scale(0.5f).move(0, 0, -1.25f);
    }
}
